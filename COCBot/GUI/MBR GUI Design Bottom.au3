...
;~ ##########################################CSV MAKER 2020######################################################################
		Local $x = 197, $y = $y_bottom +75 ;#####################################################################################
		$g_hCSVMakerMainButton = GUICtrlCreateButton("",$x,$y,90,30,BitOR($BS_CENTER, $BS_BITMAP, $WS_BORDER));##################
		GUICtrlSetImage($g_hCSVMakerMainButton, @ScriptDir & "\COCBot\CSVMAKER2020\USE\mainButton.bmp", 0);######################
		GUICtrlSetCursor (-1, 0) ;###############################################################################################
		GUICtrlSetOnEvent(-1, "OpenCSVMakerGUI") ;##################################################################################
;~ ~ ##############################################################################################################################
		GUI_CSVMAKER() ;######################################################################################################
