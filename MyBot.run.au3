...
;~ #########################################################################################################################################################################################################################################################
			If (GUICtrlRead($DoRandomiseDB) = $GUI_CHECKED And GUICtrlRead($g_hGUI_DEADBASE_TAB) = $GUI_CHECKED) Or (GUICtrlRead($DoRandomiseAB) = $GUI_CHECKED And GUICtrlRead($g_hGUI_ACTIVEBASE_TAB) = $GUI_CHECKED) Then ;##############################
				RondamiseCSVDB() ;##########################################################################################################################################################################################################################
				RondamiseCSVAB() ;##########################################################################################################################################################################################################################
				SetLog("Random Indexes that you set with CSVMAKER 2020, changed randomly.",$COLOR_SUCCESS) ;################################################################################################################################################
			EndIf ;#########################################################################################################################################################################################################################################
;~ #########################################################################################################################################################################################################################################################
